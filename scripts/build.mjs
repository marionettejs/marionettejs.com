...
const revision = await promisify(execFile)('git', ['log', '-1', '--format=%cI'], { cwd: root })
  .then(({ stdout }) => stdout.trim().slice(0, 10), () => new Date().toISOString().slice(0, 10));
