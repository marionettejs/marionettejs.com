...
const sitemapRoutes = ['/development/', '/troubleshooting/', '/', '/why/', '/thanks/', '/errors/', '/docs/agent-start/', '/docs/coverage/', '/docs/mcp/', ...diagnostics.diagnostics.map(entry => entry.docsAnchor), ...docsManifest.pages.map(page => `/${page.route}/`)];
