...
import { buildLibraryDocs, deriveMarkdown } from './library-docs.mjs';
...
const stylesheetUrls = Object.fromEntries(await Promise.all(['site', 'night', 'playground', 'docs'].map(async name => {
...
for (const [route, page] of [['',home], ['why',why], ['thanks',thanks]]) {
