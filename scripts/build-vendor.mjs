...
if (pkg.version !== '5.0.0-beta.5' || docs.packageVersion !== pkg.version || docs.sourceDirty) throw new Error('Expected the published beta package and matching clean documentation.');
...
await writeFile(resolve(root, 'content/provenance.json'), JSON.stringify({
  ...
  publication: 'Marionette 5.0.0-beta.5 public website',
