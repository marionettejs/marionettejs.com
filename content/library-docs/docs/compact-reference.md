...
| Application | Named children belong to the Application until removal. setView temporarily owns a prepared View; showView hands it to the Region and releases Application ownership. Without preparation, getView reads the Region currentView, including direct Region display. | [Application Lifecycle](./marionette.application.md) |
