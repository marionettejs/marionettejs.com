...
```sh
npm install marionette@5.0.0-beta.5 @mnjs/adapters@5.0.0-beta.5 backbone
```
...
```sh
npm install marionette@5.0.0-beta.5 @mnjs/adapters@5.0.0-beta.5 xstate
```
...
```sh
npm install marionette@5.0.0-beta.5 @mnjs/adapters@5.0.0-beta.5 jquery
```
...
```sh
npm install marionette@5.0.0-beta.5 @mnjs/adapters@5.0.0-beta.5 morphdom
```
...
```sh
npm install marionette@5.0.0-beta.5 @mnjs/adapters@5.0.0-beta.5 lit-html
```
