...
```sh
npm install marionette@5.0.0-beta.6 @mnjs/adapters@5.0.0-beta.6 backbone
```
...
```sh
npm install marionette@5.0.0-beta.6 @mnjs/adapters@5.0.0-beta.6 xstate
```
...
```sh
npm install marionette@5.0.0-beta.6 @mnjs/adapters@5.0.0-beta.6 jquery
```
...
```sh
npm install marionette@5.0.0-beta.6 @mnjs/adapters@5.0.0-beta.6 morphdom
```
...
```sh
npm install marionette@5.0.0-beta.6 @mnjs/adapters@5.0.0-beta.6 lit-html
```
