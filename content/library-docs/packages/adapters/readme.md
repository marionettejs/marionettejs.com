...
```sh
npm install marionette@5.0.0-rc.1 @mnjs/adapters@5.0.0-rc.1 backbone
```
...
```sh
npm install marionette@5.0.0-rc.1 @mnjs/adapters@5.0.0-rc.1 xstate
```
...
```sh
npm install marionette@5.0.0-rc.1 @mnjs/adapters@5.0.0-rc.1 jquery
```
...
```sh
npm install marionette@5.0.0-rc.1 @mnjs/adapters@5.0.0-rc.1 morphdom
```
...
```sh
npm install marionette@5.0.0-rc.1 @mnjs/adapters@5.0.0-rc.1 lit-html
```
