...
```sh
npm install marionette@5.0.0-beta.4 @mnjs/adapters@5.0.0-beta.4 backbone
```
...
```sh
npm install marionette@5.0.0-beta.4 @mnjs/adapters@5.0.0-beta.4 xstate
```
...
```sh
npm install marionette@5.0.0-beta.4 @mnjs/adapters@5.0.0-beta.4 jquery
```
...
```sh
npm install marionette@5.0.0-beta.4 @mnjs/adapters@5.0.0-beta.4 morphdom
```
...
```sh
npm install marionette@5.0.0-beta.4 @mnjs/adapters@5.0.0-beta.4 lit-html
```
